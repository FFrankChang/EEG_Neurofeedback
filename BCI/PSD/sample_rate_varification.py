...
raw_data_file = open('raw_data_final.csv', 'w', newline='')
power_bands_file = open('power_bands_final.csv', 'w', newline='')
...
while True:
    ...
    if samples:
        ...
        # buffer[-step_samples:] = sample[0:3]
...
end_time = time.time()
raw_data_file.close()
print(end_time -start_time,sample_count)
