...
for i in range(1,11):
    ...
    easy_data = data[data['scenario'] == 'easy']
    ...
    plot_data(ax1, hard_data, 'Steering Angle Std Variation Over Time with Conditions (Hard Scenario)')
    plot_data(ax2, easy_data, 'Steering Angle Std Variation Over Time with Conditions (Easy Scenario)')
