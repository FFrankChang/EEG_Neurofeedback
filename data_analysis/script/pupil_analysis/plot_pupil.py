...
def interactive_plot(data):
    ...
    # 第一个子图：瞳孔直径
    scat_left = ax1.scatter(data['StorageTime'][start:end], data['smarteye|LeftPupilDiameter'][start:end], color='b', label='Left Pupil Diameter', alpha=0.5)
    scat_right = ax1.scatter(data['StorageTime'][start:end], data['smarteye|RightPupilDiameter'][start:end], color='g', label='Right Pupil Diameter', alpha=0.5)
...
# 主函数
def main():
    filename = r'D:\Frank_Project\EEG_Neurofeedback\data\20240531_s10_12_hard_feedback\Entity_Recording_2024_05_31_22_29_18(smarteye).csv'  # 修改为你的文件名
