...
# 筛选Day为D01的数据
data_d01 = data[data['Condition'] == 'feedback']
...
# 创建空DataFrame以存储检验结果
wilcoxon_results = pd.DataFrame(columns=['Variable', 'Statistic', 'P-value'])

# 遍历列，进行Wilcoxon检验
for column in columns_to_test:
    feedback_scores = data_d01[data_d01['Day'] == 'D01'][column].values
    silence_scores = data_d01[data_d01['Day'] == 'D02'][column].values
