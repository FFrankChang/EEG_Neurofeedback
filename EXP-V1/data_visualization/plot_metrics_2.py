...
for column in columns:
    ...
    for i in range(0, unique_subject_days, 4):  # Assuming each subject has exactly 4 entries (2 days * 2 conditions)
        ax.axvspan(i-0.5, i+3.5, color='grey', alpha=0.1 if i % 8 == 0 else 0.3, zorder=0)
