...
# Load the CSV file
file_path = r'E:\Frank_Projects\EEG_Neurofeedback_Frank\grouped_expv1_c01_results_e_feedback.csv'
...
palette = {"silence": "gray", "feedback": "lightblue"}  # blue color for feedback, gray for silence
