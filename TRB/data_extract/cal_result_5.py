    ...
    for time in range(10,70,10):
        ...
        for folder in subject_folders:
            ...
            for file_path in file_paths:
                result = process_file(file_path,duration=time)
            ...
            results_df['Group'] = results_df['Subject'].apply(lambda x: 'Real' if x in ['S01', 'S02', 'S03', 'S04', 'S05', 'S06'] else 'Sham')
        ...
        final_df.to_csv(f'final_results_{time}s.csv', index=False)
